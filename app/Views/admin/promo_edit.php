                        ...
                        <div class="card-panel cf">
                            <div class="col s12">
                                <form action="<?= base_url() ?>/admin/promo/save" enctype="multipart/form-data" method="post" class="modal-form">
                                    ...
                                    <div class="input-field col s12">
                                        <textarea name="deskripsi" id="deskripsi" class="materialize-textarea validate <?= validCheck($validation->getError('deskripsi')) ?>"><?= oldCheck('deskripsi', $promo->deskripsi) ?></textarea>
